...
// 🔧 CORREÇÃO: Garantir que o documento do usuário existe
...
// 🔥 DEPÓSITO (ORIGINAL, SEM ALTERAÇÕES NO QR CODE)
app.post("/deposito", authMiddleware, async (req, res) => {
  ...
  try {
    ...
    // Salvar no Firestore para tracking (opcional)
    try {
...
// 🔥 VERIFICAR PAGAMENTO (COM CORREÇÃO DO SALDO)
